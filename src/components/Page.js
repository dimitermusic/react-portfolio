  ...
  const renderPageContent = () => {
    return (
      ...
      >
        ...
        <div style={{marginTop: '20px'}}>
          <iframe src='https://player.vimeo.com/video/984691330?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479' width={window.innerWidth > 960 ? '960' : '336'} height={window.innerWidth > 960 ? '540' : '189'} frameborder='0' allow='autoplay; fullscreen; picture-in-picture; clipboard-write' title='Dimiter Yordanov Summer Mix Demo Reel'></iframe>
        </div>
